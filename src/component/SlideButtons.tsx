...
const SlideButtons:React.FC<SlideButtonsProps> = (props) => {
    ...
    return (
        <div className="flex flex-col justify-center py-2 px-2 md:mr-2 opacity-50 md:opacity-40 hover:opacity-100 items-center rounded-xl bg-zinc-100">
            ...
            >
                ...
                >
                    ...
                    >
                        ...
                        <button
                            className={`w-2 h-2 rounded-3xl mx-1 ${props.subslide === 4 ? "bg-amber-600" : "bg-zinc-600 hover:bg-amber-500"}`}
